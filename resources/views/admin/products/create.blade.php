            ...
            <form action="{{ route('admin.products.store') }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">{{ config('cart.currency') }}</span>
                            <input type="text" name="old_price" id="old_price" placeholder="Old Price" class="form-control" value="{{ old('old_price') }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="front_status" id="front_status" class="form-control">
                            ...
                            <option   value="recommended">Рекомендація</option>
                            <option   value="action">Акція</option>
                            <option   value="commodity_day">Товар дня</option>
