                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @elseif(isset($product->discount))
                                                        <div class="input-group">
                                                            <span class="input-group-addon">{{ config('cart.currency') }}</span>
                                                            <input type="text" name="price" id="price" placeholder="Price" disabled class="form-control" value="{!! $product->price !!}">
                                                        </div>
                                                    @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="discount" id="discount" placeholder="discount" class="form-control" value="{{ $product->discount }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="front_status">Статус відображення</label>
                                                <select name="front_status" id="front_status" class="form-control">
                                                    <option> </option>
                                                    <option @if ($product->front_status=="new") selected @endif value="new">Новий</option>
                                                    <option @if ($product->front_status=='sale') selected @endif  value="sale">Розпродаж</option>
                                                    <option @if ($product->front_status=='recommended') selected @endif  value="recommended">Рекомендація</option>
                                                    <option @if ($product->front_status=='action') selected @endif  value="action">Акція</option>
                                                    <option @if ($product->front_status=='commodity_day') selected @endif  value="commodity_day">Товар дня</option>
                                                    <option @if ($product->front_status=='bu') selected @endif  value="bu">Б/У</option>
                                                </select>
                                            </div>
                                            <!-- /.box-body -->
                                        </div>
